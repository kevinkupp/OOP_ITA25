...
def filter_by_hobby(people_list: list, hobby: str) -> list:
    ...
    people_filtered = filter(lambda person: hobby in person.hobbies, people_list)
    return list(people_filtered)
...
def sort_by_most_hobbies(people_list: list) -> list:
    ...
    """
    amount_hobbies = sorted(people_list, key=lambda person: (-len(person.hobbies), person.full_name))
    return list(amount_hobbies)
...
def sort_people_and_hobbies(people_list: list) -> list:
    ...
    :return: sorted list of people.
    """
    amount_hobbies = sorted(people_list, key=lambda person: ((person.hobbies).sort(), person.full_name))
    return list(amount_hobbies)
