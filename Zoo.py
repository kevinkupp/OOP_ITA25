...
class Zoo:
    ...
    def can_add_animal(self, animal: Animal) -> bool:
        ...
        for some_animal in self.animals_in_zoo:
            if animal.name == some_animal.name and some_animal.species == animal.species:
                return False

            if self.max_number_of_animals <= len(self.animals_in_zoo):
                return False
    ...
    def get_animals_by_age(self):
        ...
        """
        animals_age = sorted(self.animals_in_zoo, key=lambda animal: animal.age)
        return animals_age
    ...
    def get_animals_sorted_alphabetically(self):
        ...
        """
        animals_alphabetically = sorted(self.animals_in_zoo, key=lambda animal: animal.name)
        return animals_alphabetically
